...
namespace FlowControlHomework
{
    ...
    public class FlowControlHomework
    {
        ...
        {
            bool changeFlow = true /*Answer Here*/; // assign me so I can reach the assert true in my flow of execution
            if (changeFlow)
            {
                Assert.IsTrue(true);
            }
        ...
        public void Loops()
        {
           int max2 = 17;
            ...
            int passedCounter = 1;  // Don't change me.
